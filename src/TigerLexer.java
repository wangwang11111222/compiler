...
public class TigerLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"THEN", "TO", "TYPE", "VAR", "WHILE", "COMMA", "COLON", "SEMI", "LPAREN", 
			"RPAREN", "LBRACK", "RBRACK", "ADD", "SUB", "MUL", "DIV", "POW", "EQ", 
			"NE", "LT", "GT", "LE", "GE", "AND", "OR", "ASSIGN", "TASSIGN", "ID", 
			"INTLIT", "FLOATLIT", "COMMENT", "WS"
		};
	}
